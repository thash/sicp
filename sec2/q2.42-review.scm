...
;;        NOTE: エイトクイーンの64C8は44億通りあるので全部列挙してからスタートしようとすると最初から爆死.
;;              なので恣意的っちゃ恣意的だけど, 現実的に解くために必要な前提です. ref: q2.42.scm のあんちべさん発言
;;
...
;; NOTE: https://twitter.com/ajiyoshi/status/286908395313823744
;; 前提2.は, 今回のadjoin-positionとsafe?の実装方針だとそう表現されるよという程度のもの.
;; 座標で((1 3) (2 2) (3 1) (4 4))と表現にしたとしても, それに対応する解答を用意すればok. 2週目はやってみよう
