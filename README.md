...
### Huffman木 -- [問題2.69](sicp/sec2/q2.69.scm), [問題2.71](sicp/sec2/q2.71.scm), [問題2.72](sicp/sec2/q2.72.scm)
...
### [問題2.88](sicp/sec2/q2.88.scm)

多項式システムに減算処理を追加する.


### [問題2.90](sicp/sec2/q2.90.scm)

"薄い"多項式と"濃い"多項式の両方を扱うシステムを作る.


### [問題2.91](sicp/sec2/q2.91.scm)

多項式の割り算. 素因数分解する必要がある.


### [問題2.92](sicp/sec2/q2.92.scm)

変数に順序(index?)を付けて多項式パッケージを拡張し, 異なる変数の多項式とでも加算/乗算ができるようにせよ.


### [問題3.19](sicp/sec3/q3.19.scm)
...
### [問題3.26](sicp/sec3/q3.26.scm)

二進木で表(table)を組織化し, 巨大データも効率良く扱えるようにする.


### [問題3.46](sicp/sec3/q3.46.scm)
...
### [問題3.61](sicp/sec3/q3.61.scm)

定数項が1の冪級数S(ref: [問題3.59](sicp/sec3/q3.59.scm))に対して
...
### [問題3.62](sicp/sec3/q3.62.scm)

問題3.60と問題3.61を使い, 二つの冪級数を割る手続き`div-series`を定義せよ.


### [問題3.64](sicp/sec3/q3.64.scm)
